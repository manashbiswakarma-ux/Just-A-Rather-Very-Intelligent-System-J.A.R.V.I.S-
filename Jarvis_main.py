...
def takeCommand():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            return "None"  # Nothing spoken within timeout

    # Try to recognize speech only if audio is not empty
    try:
        ...
        if "wake up" in query:
            ...
            while True:
                ...
                ############################################################
                    ...
                    words = query.split()
                    city = "Guwahati"  # default

                    # Try to find city after the word "in"
                    ...
                    if "yes" in shutdown:
                        ...
                        if system == "Windows":
                            ...
                            speak("Shutdown command is not supported on your OS.")
                    elif "no" in shutdown:
                    ...
                    if query and query != "none" and len(query.strip()) > 2:
                        ai_reply = ask_gemini(query)
                        print("Gemini:", ai_reply)
                        speak(ai_reply)
                    else:
                        # Ignore noise or empty result
                        continue
